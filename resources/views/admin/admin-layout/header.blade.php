        ...
        <aside class="w-64 bg-white shadow-md hidden md:block">
            ...
            <nav class="mt-6">
                <a href="{{ route('dashboard') }}"
                    class="block px-6 py-3 text-gray-700 hover:bg-gray-200 rounded">Dashboard</a>
                <a href="{{ route('profile.show') }}"
                    class="block px-6 py-3 text-gray-700 hover:bg-gray-200 rounded">Profile</a>
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit"
                        class="w-full text-left px-6 py-3 text-red-600 hover:bg-red-100 rounded">Logout</button>
                </form>
            </nav>
        </aside>
        ...
        <div class="flex-1 flex flex-col overflow-auto">
            ...
            <div id="mobile-menu" class="md:hidden hidden bg-white shadow-md">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit"
                        class="w-full text-left px-4 py-3 text-red-600 hover:bg-red-100">Logout</button>
                </form>
            </div>