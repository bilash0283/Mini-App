...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('Categ  1w3333hhotory/Store', [CategoryController::class, 'store'])->name('category.store');
    ...
    Route::post('/blogs', [BlogController::class, 'blog_store'])->name('blogs.store');
